...
test(`diffPatch(${case1[0]}, ${case1[1]}):`, () => {
  expect(main.diffPatch(case1[0], case1[1])).toEqual({
    after: '<ins>2</ins>',
    before: '<del>1</del>'
  })
})
...
test(`diffPatch("${case2[0]}", "${case2[1]}"):`, () => {
  expect(main.diffPatch(case2[0], case2[1])).toEqual({
...
test(`diffPatch("${case3[0]}", "${case3[1]}"):`, () => {
  expect(main.diffPatch(case3[0], case3[1])).toEqual({
...
test(`diffPatch("${case4[0]}", "${case4[1]}"):`, () => {
  expect(main.diffPatch(case4[0], case4[1])).toEqual({
    after: '',
...
test(`diffPatch("${case5[0]}", "${case5[1]}"):`, () => {
  expect(main.diffPatch(case5[0], case5[1])).toEqual({
    after: '',
    before: ''
  })
})
...
test(`diffPatchBySeparator(${case1[0]}, ${case1[1]}):`, () => {
  expect(main.diffPatchBySeparator(case1[0], case1[1])).toEqual({
    after: '<ins>2</ins>',
    before: '<del>1</del>'
  })
})
...
test(`diffPatchBySeparator("${case2[0]}", "${case2[1]}"):`, () => {
  expect(main.diffPatchBySeparator(case2[0], case2[1])).toEqual({
    after: '<ins>付费对外开放</ins>',
...
test(`diffPatchBySeparator("${case3[0]}", "${case3[1]}"):`, () => {
  expect(main.diffPatchBySeparator(case3[0], case3[1])).toEqual({
    after: '<ins>付费对外开放</ins>',
    before: ''
  })
})
...
test(`diffPatchBySeparator("${case4[0]}", "${case4[1]}"):`, () => {
  expect(main.diffPatchBySeparator(case4[0], case4[1])).toEqual({
    after: '',
    before: '<del>付费对外开放</del>'
  })
})
...
test(`diffPatchBySeparator("${case5[0]}", "${case5[1]}"):`, () => {
  expect(main.diffPatchBySeparator(case5[0], case5[1])).toEqual({
    after: '',
    before: ''
  })
})
...
test(`diffPatchBySeparator("${case6[0]}", "${case6[1]}",'br'):`, () => {
  expect(main.diffPatchBySeparator(case6[0], case6[1],'br')).toEqual({
